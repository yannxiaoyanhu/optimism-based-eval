...
def get_imagenet_models(device, img_size=128, num_classes=1000):
    ...
    the official repository of Studio GAN: https://github.com/POSTECH-CVLab/PyTorch-StudioGAN, which are
    saved under the directory ./gen_models/pretrained_weights.
    """
